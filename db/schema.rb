...
ActiveRecord::Schema.define(version: 20150308042657) do
  ...
  add_index "project_interests", ["project_id"], name: "index_project_interests_on_project_id", using: :btree
  add_index "project_interests", ["user_id"], name: "index_project_interests_on_user_id", using: :btree
